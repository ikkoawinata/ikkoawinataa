...
//   return (
//     <article className="relative flex max-w-sm flex-col items-start justify-between border border-gray-200 dark:border-gray-700 rounded-md p-3 bg-zinc-100 dark:bg-gray-800 shadow-md dark:shadow-lg">
//       <div className="flex items-center gap-x-2 text-xs">
//         <time dateTime={post.datetime} className="text-gray-500 dark:text-gray-400">
//           {post.date}
//         </time>
